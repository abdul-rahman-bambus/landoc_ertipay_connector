...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        partner_val = data['form'].get('partner_id')
        selected_partner_id = partner_val[0] if isinstance(partner_val, list) else partner_val
        ...
        if selected_partner_id:
            ...
            query += " AND account_move_line.partner_id = %s"
            params.append(selected_partner_id)
        ...
        if selected_partner_id:
            partners = obj_partner.browse([selected_partner_id])
        else:
        ...
        return {
            'doc_ids': [p.id for p in partners],
