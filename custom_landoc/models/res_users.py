...
class ResUsers(models.Model):
    ...
    allowed_department_ids = fields.Many2many('crm.team', ondelete='cascade')
    default_department_id = fields.Many2one('crm.team', string='Default Department', required=True)
